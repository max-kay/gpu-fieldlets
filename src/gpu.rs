...
pub struct MetalState {
    ...
    pub pipeline_d_vels: Retained<ProtocolObject<dyn MTLComputePipelineState>>,
    ...
    pub buf_dir_vel: Retained<ProtocolObject<dyn MTLBuffer>>,
...
impl MetalState {
    pub fn new(params: &SimulationParameters, positions: &[Vec3], directions: &[Vec3]) -> Self {
        ...
        Self {
            ...
            pipeline_d_vels: get_pipeline("update_d_vels"),
            ...
            buf_dir_vel: buf(&zeros),
            buf_check_output: device.newBufferWithLength_options(8, MTLResourceOptions::StorageModeShared).unwrap(),
        }
    }
